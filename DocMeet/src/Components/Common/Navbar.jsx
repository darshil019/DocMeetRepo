            ...
            <div className="fixed bg-white inset-0 z-50 p-5">
              ...
              <div className="flex flex-col space-y-6">
                ...
                <div className="flex flex-col space-y-3 p-3">
                  ...
                  <button onClick={() => window.location.href = '/login'} className="bg-gray-300 text-black px-3 py-2 rounded-lg text-sm hover:bg-[#5D6BFF] hover:text-white">SignIn</button>                </div>
              </div>
            </div>
          )}
        </div>
