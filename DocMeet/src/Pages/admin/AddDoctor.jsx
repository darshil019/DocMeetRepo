            ...
            <form className="w-full p-4 md:p-8 flex flex-col">
                <div className="bg-white px-4 md:px-8 py-6 border rounded w-full max-w-6xl mx-auto flex-grow shadow-md">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 text-gray-600">
                        ...
                        <p className="mb-1 font-medium">Slot Duration (minutes)</p>
                            <input
                                type="number"
                                name="slotDuration"
                            ...
                            <div>
                                ...
                                <input type="file" name="doctorImage" value={doctorData.doctorImage ?.imgPath || ''} className="w-full p-2 border rounded" onChange={((e) => { setImageStore(e.target.files[0]) })}  />
                            </div>
